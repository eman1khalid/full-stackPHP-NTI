...
if(!isset( $_SESSION["logstate"]) || !$_SESSION["logstate"]){header("Location:DAY9-register.php");exit;} ?>
...
<div class="container mt-5">
    ...
    <button type="submit" class="btn btn-primary w-100">add product</button>
        ...
        <?php  
             ...
             header("Location: DAY9-products.php?success=1"); exit;} ?>
        <div class="card-body ">
          <div class="row d-flex">
            <?php 
    ...
    <?php }} ?> </div></div></div>
  <a href="DAY9-logout.php" class="btn btn-primary active  w-100 mt-5"   >Logout</a>
    <a href="DAY9-welcom.php" class="btn btn-primary active  w-100 mt-5" >go to welcom</a>
</div></div>
