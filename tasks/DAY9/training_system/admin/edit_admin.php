...
<div class="container mt-5 bg-info">
    <div class=" row ">
    <form class="was-validated " method="POST" enctype="multipart/form-data" action="update_admin.php?email=<?=$email?>">
        <div class="row justify-content-center d-flex mt-5">
            <div class="  mt-3  ">
             <label for="validationServerUsername" class="form-label text-light"> username</label>
            <input type="text" class="form-control" name="name" value="<?= htmlspecialchars($admin["username"]) ?>" required>
            </div>
            ...
            <select class="form-select is-invalid "  name="role" required>
             ...
             <option   value="user">user</option></select></div> <?php }?>
