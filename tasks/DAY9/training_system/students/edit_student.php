...
<div class="container mt-5 bg-info">
    <div class=" row ">
    <form class="was-validated " method="POST" enctype="multipart/form-data" action="update_student.php?id=<?=$id?>">
        <div class="row justify-content-center d-flex mt-5">
            ...
            <input type="number" class="form-control" name="phone" value=<?=$student["phone"] ?> required>
             ...
             <input type="date" class="form-control" name="date" value=<?=$student["date_of_birth"] ?> required>
            </div>
